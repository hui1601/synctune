...
public class LyricsEvent {
    ...
    public static class LyricsFoundEvent extends BaseEvent {
        ...
        public String getLrcFilePath() { return lrcFilePath; }
        @Override public String toString() { return super.toString() + " {musicFile=" + musicFilePath + ", lrcFile=" + lrcFilePath + "}"; }
    }
    ...
    public static class LyricsNotFoundEvent extends BaseEvent {
        ...
        public String getMusicFilePath() { return musicFilePath; }
        @Override public String toString() { return super.toString() + " {musicFile=" + musicFilePath + "}"; }
    }
    ...
    public static class NextLyricsEvent extends BaseEvent {
        ...
        public String getLyricLine() { return lyricLine; }
        public long getStartTimeMillis() { return startTimeMillis; }
        @Override public String toString() { return super.toString() + " {line=\"" + lyricLine + "\", time=" + startTimeMillis + "ms}"; }
    }
    ...
    public static class LyricsParseCompleteEvent extends BaseEvent { // 추가: LRC 파싱 완료
        ...
        @Override public String toString() { return super.toString() + " {musicFile=" + musicFilePath + ", success=" + success + "}"; }
    }
}