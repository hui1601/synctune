...
public class MediaInfoEvent {
    ...
    public static class MediaScanStartedEvent extends BaseEvent {
        ...
        public MediaScanStartedEvent(String directoryPath) {
        ...
        public String toString() {
            return super.toString() + " {directory=" + directoryPath + "}";
        }
    }
    ...
    public static class MediaScanProgressEvent extends BaseEvent {
        ...
        @Override
        public String toString() {
            return super.toString() + " {scanned=" + scannedFiles + "/" + totalFiles + "}";
        }
    }
    ...
    public static class MediaScanCompletedEvent extends BaseEvent {
        ...
        public List<MusicInfo> getScannedMusicInfos() {
            return scannedMusicInfos;
        }

        @Override
        public String toString() {
            return super.toString() + " {count=" + scannedMusicInfos.size() + "}";
        }
    }
    ...
    public static class MetadataUpdatedEvent extends BaseEvent { // LRC 등에서 메타데이터 업데이트 시
        ...
        public MusicInfo getUpdatedMusicInfo() {
            return updatedMusicInfo;
        }

        @Override
        public String toString() {
            return super.toString() + " {music=" + updatedMusicInfo.getTitle() + "}";
        }
    }
}