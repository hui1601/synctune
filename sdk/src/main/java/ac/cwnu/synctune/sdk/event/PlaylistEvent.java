...
public class PlaylistEvent {
    ...
    public static class PlaylistCreatedEvent extends BaseEvent {
        ...
        public String toString() {
            return super.toString() + " {playlistName=" + playlist.getName() + "}";
        }
    }
    ...
    public static class PlaylistDeletedEvent extends BaseEvent {
        ...
        public PlaylistDeletedEvent(String playlistName) {
    ...
    public static class MusicAddedToPlaylistEvent extends BaseEvent {
        ...
        @Override
        public String toString() {
            return super.toString() + " {playlistName=" + playlistName + ", music=" + musicInfo.getTitle() + "}";
        }
    }
    ...
    public static class PlaylistOrderChangedEvent extends BaseEvent {
        ...
        public PlaylistOrderChangedEvent(Playlist playlist) {
            this.playlist = playlist;
        }
    ...
    public static class AllPlaylistsLoadedEvent extends BaseEvent { // 추가: 모든 플레이리스트 로드 완료
        ...
        public AllPlaylistsLoadedEvent(List<Playlist> playlists) {
        ...
        @Override
        public String toString() {
            return super.toString() + " {count=" + playlists.size() + "}";
        }
    }
}